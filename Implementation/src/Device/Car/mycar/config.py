...
JOYSTICK_MAX_THROTTLE = 0.19         #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
...
TELEMETRY_DONKEY_NAME = 'robot1234'
TELEMETRY_MQTT_TOPIC_TEMPLATE = 'hello%s/tayyab'
